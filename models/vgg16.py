"""
VGG-16 model loader with pre-trained ImageNet weights.
"""
...
def load_vgg16(pretrained=True, device='cuda'):
    """
    Load VGG-16 with ImageNet pre-trained weights.
    ...
    Returns:
        model: VGG-16 model in eval mode
    """
